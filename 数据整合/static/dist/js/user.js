...
$(function () {
   ...
   // $("#jqGrid").trigger("reloadGrid");
    	//$("#jqGrid").jqGrid('clearGridData').trigger("reloadGrid");
  $("#jqGrid").jqGrid({
	  
	url: 'courses/list?keyword='+keyword,
    datatype: "json",
    colModel: [
...
function btn_Search() {
	 keyword = document.getElementById("keyword").value;
	 jQuery("#jqGrid").setGridParam({url:'courses/list?keyword='+keyword}).trigger("reloadGrid");
}
